...
- 🔗 **Создаёт жёсткие ссылки вместо перемещения файлов** - оригиналы сохраняются
...
└── Sousou no Frieren (2023)/
    └── Season 01/
        ├── Sousou no Frieren S01E01.mkv  ← жёсткая ссылка
        ├── Sousou no Frieren S01E01.nfo  ← жёсткая ссылка
        ├── Sousou no Frieren S01E02.mkv  ← жёсткая ссылка
        └── ...
```
